...
def get_args():
    ...
    file_size = "700-"
    source_dir = '700-'#"/mnt/ficusukraine/qlin/qa4ie/{}".format(file_size)
    target_dir = "data/qa4ie/{}/span".format(file_size)
...
def prepro_each(args, data_type, start_ratio=0.0, stop_ratio=1.0, out_name="default", in_path=None):
    ...
    source_path = in_path or os.path.join(args.source_dir, "{}.span.json".format(data_type))
