...
flags.DEFINE_string("model_name", "qanewm", "Model name [basic]")
flags.DEFINE_string("data_dir", "data/scoreqa", "Data dir [data/qa4ie]")
flags.DEFINE_string("data_scale", "400-700", "Dataset scale: 0-400 | 400-700 | 700- [0-400]")
flags.DEFINE_string("data_type", "seq", "Dataset type: span | seq [span]")
...
flags.DEFINE_integer("batch_size", 5, "Batch size [20]")
flags.DEFINE_integer("val_num_batches", 100, "validation num batches [100]")
flags.DEFINE_integer("test_num_batches", 0, "test num batches [0]")
flags.DEFINE_integer("num_epochs", 12, "Total number of epochs for training [12]")
flags.DEFINE_integer("num_steps", 0, "Number of steps [10000]")
