...
flags.DEFINE_string("model_name", "final", "Model name [basic]")
flags.DEFINE_string("data_dir", "data/scoring/", "Data dir [data/squad]")
#flags.DEFINE_string("data_scale", "700-", "Dataset scale: 0-400 | 400-700 | 700- [0-400]")
...
flags.DEFINE_integer("batch_size", 512, "Batch size [60]")
...
flags.DEFINE_integer("load_step", 150000, "load step [0]")
...
flags.DEFINE_bool("share_lstm_weights", False, "Share pre-processing (phrase-level) LSTM weights [True]")
...
flags.DEFINE_integer("log_period", 50, "Log period [100]")
...
flags.DEFINE_integer("word_count_th", 15, "word count th [100]")
